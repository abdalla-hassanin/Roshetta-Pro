...
myBloodDropDownField({required BuildContext context}) {
  return Column(
      ...
      children: [
        ...
        Directionality(
          ...
          child: DropdownButtonFormField(
            ...
            onChanged: (value) {
              AuthCubit.get(context).changeBloodValue(value);
            },
            icon: Iconify(
              Ic.twotone_keyboard_arrow_down,
              color: colorBlueC0,
            ),
            items: ['A+', 'A-', 'B-', 'B+', 'O-', 'O+', 'AB-', 'AB+'].map((e) {
